...
const rehypeMermaid: Plugin<[MermaidOptions?], Root> = (options = {}) => {
    ...
    return (tree) => {
        visit(tree, "element", (node: Element) => {
            // We only care about code blocks with mermaid.
            ...
            try {
                ...
                try {
                    ...
                    const configArg = process.env.NODE_ENV === 'development' ? '' : '-p puppeteer-vercel.config.json';
                    execSync(
                    ...
                    node.children = [
                        {
                            ...
                            properties: {
                                src: lightDataUrl,
                                className: "dark:hidden max-h-120 mermaid-light"
                            },
                            children: []
                        },
                        {
                            ...
                            properties: {
                                src: darkDataUrl,
                                className: "hidden dark:block max-h-120 mermaid-dark"
                            },
                            children: []
                        }
                    ];
