...
const content = {
  heading: "Apalis Blog",
  description: "Stay up-to-date with all the latest and greatest news coming from the Apalis ecosystem!"
}
              ...
              >
                ...
                <div className="flex pl-2 items-center mt-4">
                  {authors.map(({ avatar, name }, index) => (
                    <div
                      key={index}
                      className="h-6 w-6 rounded-sm relative overflow-hidden -ml-2 border border-black dark:border-white shadow"
                    >
