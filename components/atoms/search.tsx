            ...
            <div className="h-full w-full bg-zinc-50 dark:bg-zinc-900 flex flex-col rounded-sm overflow-hidden">
              ...
              >
                ...
                <div className="flex gap-2 items-center px-4 py-2 border-t border-zinc-200 dark:border-zinc-800 text-zinc-400 dark:text-zinc-500 text-sm">
                  ...
                  <span>
                    Search powered by{" "}
                    <Link href="https://www.algolia.com/" className="underline">
                      Algolia
                    </Link>
                    .
                  </span>
        ...
        return (
          <Fragment key={index}>
            ...
            <Link
              ...
              className="flex items-center justify-between gap-4 p-4 pt-3 pb-3.5 mt-2 rounded-sm border-2 border-transparent bg-zinc-100 dark:bg-zinc-800 hover:border-zinc-300 dark:hover:border-zinc-700 focus:outline-none focus:border-zinc-300 dark:focus:border-zinc-700"
            >
              <div>
                <div>
                  <Highlight
