---
title: Extending Workers
excerpt: In apalis, layers provide a way to extend worker functionality by wrapping task execution logic with additional behavior.
